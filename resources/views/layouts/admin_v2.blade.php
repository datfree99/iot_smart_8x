...
<body>
<!-- Layout wrapper -->
<div class="layout-wrapper layout-content-navbar layout-admin-custom">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
              ...
              <span class="app-brand-logo demo">
                <svg
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bold ms-2">Iot smart</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-header small text-uppercase">
                    <span class="menu-header-text">Quản trị web</span>
                </li>
                <li class="menu-item @if(request()->routeIs(['admin.slider.index', 'admin.slider.create', 'admin.slider.edit'])) active @endif">
                    <a href="{{route('admin.slider.index')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-collection"></i>
                        <div data-i18n="Slider">Slider</div>
                    </a>
                </li>
                <li class="menu-item @if(request()->routeIs('admin.about-us')) active @endif">
                    <a href="{{route('admin.about-us')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-user-check"></i>
                        <div data-i18n="Sliders">About us</div>
                    </a>
                </li>
                ...
                <li class="menu-item @if(request()->routeIs(['admin.post.index', 'admin.post.create', 'admin.post.edit'])) active @endif">
                    <a href="{{route('admin.post.index')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-layout"></i>
                        <div data-i18n="Categories">Posts</div>
                    </a>
                </li>
            </ul>
        </aside>
            ...
            <nav
                ...
                <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                    ...
                    <div class="navbar-nav align-items-center">
                        <div class="text-muted fw-light breadcrumb-header">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <span class="fw-medium d-block">Iot smart</span>
